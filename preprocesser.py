...
class seqFilter:
    ...
    def addFiguresToReport(self, reporter):
        if self.options.read2_file != None:
            ...
            reporter.addFigure('Read1 base content distribution after filtering', self.r1qc_postfilter.contentPlotly("r1_post_content", 'Read1 quality curve after filtering'), "r1_post_content", "")
            ...
            reporter.addFigure('Read2 base content distribution after filtering', self.r2qc_postfilter.contentPlotly("r2_post_content", 'Read2 quality curve after filtering'), "r2_post_content", "")
